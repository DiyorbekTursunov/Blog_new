    ...
    const faqs = [
        {
            ...
            text: "Get started with FXIFY",
            asticles: "10 Articles",
            svg: (<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M3.33398 10V7.03335C3.33398 3.35001 5.94232 1.84168 9.13398 3.68335L11.709 5.16668L14.284 6.65001C17.4757 8.49168 17.4757 11.5083 14.284 13.35L11.709 14.8333L9.13398 16.3167C5.94232 18.1583 3.33398 16.65 3.33398 12.9667V10Z" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            )
        },
        {
        ...
        },
        {
            ...
            text: "Monthly Subscription / Payment FAQ / Activition Fees",
            asticles: "6 Articles",
            svg: (
        ...
        },
        {
            ...
            text: "Connection instruction / Platform Settings / RTrader Pro",
            asticles: "14 Articles",
            svg: (
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.66602 14.2167H9.99935" stroke="white" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M3.51599 11.25H8.14937C9.63271 11.25 9.99935 11.6167 9.99935 13.0833V16.5083C9.99935 17.975 9.63271 18.3417 8.14937 18.3417H3.51599C2.03266 18.3417 1.66602 17.975 1.66602 16.5083V13.0833C1.66602 11.6167 2.03266 11.25 3.51599 11.25Z" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M18.3333 12.5C18.3333 15.725 15.725 18.3333 12.5 18.3333L13.375 16.875" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M1.66602 7.50002C1.66602 4.27502 4.27435 1.66669 7.49935 1.66669L6.62436 3.12502" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M15.416 9.16669C17.4871 9.16669 19.166 7.48775 19.166 5.41669C19.166 3.34562 17.4871 1.66669 15.416 1.66669C13.3449 1.66669 11.666 3.34562 11.666 5.41669C11.666 7.48775 13.3449 9.16669 15.416 9.16669Z" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            )
        },
        {
            ...
            text: "Evaluation FAQ/ Rules & Parameters",
            asticles: "13 Articles",
            svg: (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M20.334 6.99996V9.01663C20.334 10.3333 19.5006 11.1666 18.184 11.1666H15.334V5.34163C15.334 4.41663 16.0923 3.66663 17.0173 3.66663C17.9257 3.67496 18.759 4.04163 19.359 4.64163C19.959 5.24996 20.334 6.08329 20.334 6.99996Z" stroke="white" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M3.66602 7.83329V19.5C3.66602 20.1916 4.44933 20.5833 4.99933 20.1666L6.42435 19.1C6.75768 18.85 7.22435 18.8833 7.52435 19.1833L8.90766 20.575C9.23266 20.9 9.76603 20.9 10.091 20.575L11.491 19.175C11.7827 18.8833 12.2494 18.85 12.5744 19.1L13.9994 20.1666C14.5494 20.575 15.3327 20.1833 15.3327 19.5V5.33329C15.3327 4.41663 16.0827 3.66663 16.9993 3.66663H7.83268H6.99935C4.49935 3.66663 3.66602 5.15829 3.66602 6.99996V7.83329Z" stroke="white" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M7 9.5H12" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M7.625 12.8333H11.375" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            )
        },
        {
            ...
            text: "News Trading Policy/ Sim funded / Live funded",
            asticles: "8 Articles",
            svg: (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {
            id: 1,
            title: "Payout inormation",
            text: "Payout Policy/ Rice payroll / 14 Day Payout",
            asticles: "3 Articles",
            svg: (
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M7.51602 2.36664L3.02435 5.86664C2.27435 6.44997 1.66602 7.69164 1.66602 8.63331V14.8083C1.66602 16.7416 3.24102 18.325 5.17435 18.325H14.8243C16.7577 18.325 18.3327 16.7416 18.3327 14.8166V8.74997C18.3327 7.74164 17.6577 6.44997 16.8327 5.87497L11.6827 2.26664C10.516 1.44997 8.64102 1.49164 7.51602 2.36664Z" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M13.75 9.58337L10.25 13.0834L8.91667 11.0834L6.25 13.75" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M12.084 9.58337H13.7507V11.25" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            )
        }
    ]
            ...
            <section className="faq_cards">
                <div className="faq_bg_container">
                    ...
                    <div className="faq_cards_container">
                        {faqs.map((faq, index) => (
                            <div className="faq_card" key={faq.id}
                        ...
                        <div className="faq_card_question">
                            ...
                            <a href="#" className="faq_card_question_link overflow-hidden">
