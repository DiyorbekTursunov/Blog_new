...
export default function Faqs_article() {
    ...
    const faqs_articles = [
        ...
        { id: 2, title: "Navigating Your Dashboard" },
        { id: 3, title: "Finding Your Perfect Evaluation at FXIFY" },
        { id: 4, title: "Getting the Most Out of FXIFY Support" },
        { id: 5, title: "FXIFY Affiliate Program" },
        { id: 6, title: "Can I use someone else's card?" },
