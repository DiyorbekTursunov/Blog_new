...
export default function Home() {
    ...
    const categories = [
        { id: 1, imgSrc: category1, title: "Best FTMO Alternatives in 2024" },
        { id: 2, imgSrc: category2, title: "Best FTMO Alternatives in 2024" },
        { id: 3, imgSrc: category3, title: "Best FTMO Alternatives in 2024" },
        { id: 4, imgSrc: category4, title: "Best FTMO Alternatives in 2024" },
        { id: 5, imgSrc: category5, title: "Best FTMO Alternatives in 2024" },
        { id: 6, imgSrc: category6, title: "Best FTMO Alternatives in 2024" },
    ];
        ...
        <>
            ...
            <section className="hero">
                <div className="hero_container">
                    ...
                    <p className="hero_text">
                        Your go-to source for the latest updates, trading tips,
                        and more from FXIFY
                    </p>
                                ...
                                >
                                    ...
                                    <div className="article_left">
                                        ...
                                        <h3 className="article_card_title">
                                            Master the Markets with FXify: Your Ultimate
                                            Trading Partner
                                        </h3>
                                        <p className="article_card_text">
                                            In today’s fast-paced financial world,
                                            having the right tools and expertise is
                                            essential for success in trading. FXify is
                                            here to be your ultimate partner, offering
            ...
            <section className="category">
                <div className="category_container">
                            ...
                            >
                                ...
                                <div className="category_card_bottom">
                                    ...
                                    <p className="category_card_text">
                                        Let’s look at prop firms offering similar or better services, programs...
                                    </p>
                                </div>
                            </div>
                        ))}
                    ...
                    <Link href="#" className="category_bottom_btn overflow-hidden">
                        <div>
